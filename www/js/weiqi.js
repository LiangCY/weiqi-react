...
},{"./lib/board":3,"./lib/constants":4,"./lib/game":5}],3:[function(require,module,exports){
"use strict";
...
var inBounds = function inBounds(rowSize, colSize, point) {
    return point.i >= 0 && point.i < rowSize && point.j >= 0 && point.j < colSize;
};
 ...
 */
var getAdjacentIntersections = function getAdjacentIntersections(rowSize, colSize, coords) {
    ...
    return deltas.map(addPair).filter(function (coord) {
        return inBounds(rowSize, colSize, coord);
    });
};

var allPositions = function allPositions(rowSize, colSize) {
    var range = _immutable2["default"].Range(0, rowSize);
 ...
 * liberties).
 */
var getGroup = function getGroup(stones, rowSize, colSize, coords) {
    ...
    var search = function search(_x4, _x5, _x6) {
        ...
        _function2: while (_again2) {
            ...
            var neighbors = getAdjacentIntersections(rowSize, colSize, stone);
...
var createEmptyGrid = (function () {
    var createGrid = function createGrid(rowSize, colSize) {
        return _immutable2["default"].Repeat(_immutable2["default"].Repeat(_constants2["default"].EMPTY, colSize).toList(), rowSize).toList();
    };

    var cache = {};
    return function (rowSize, colSize) {
        return cache[rowSize + "-" + colSize] || (cache[rowSize + "-" + colSize] = createGrid(rowSize, colSize));
    };
})();

var Board = (function () {
    function Board(rowSize, colSize, stones) {
        _classCallCheck(this, Board);

        if (typeof rowSize === "undefined" || rowSize < 0) throw "Size must be an integer greater than zero";

        if (typeof colSize === "undefined" || colSize < 0) throw "Size must be an integer greater than zero";
    ...
    _createClass(Board, [{
        ...
        value: function getIntersections() {
            ...
            return createEmptyGrid(this.rowSize, this.colSize).withMutations(mergeStones);
        }
    }, {
        key: "play",
        value: function play(color, coords) {
            ...
            if (!inBounds(this.rowSize, this.colSize, coords)) throw "Intersection out of bounds";
            ...
            var neighbors = getAdjacentIntersections(this.rowSize, this.colSize, coords);
            ...
            var captured = neighborColors.filter(isOpponentColor).map(function (val, coord) {
                return getGroup(newBoard, _this2.rowSize, _this2.colSize, coord);
            }).valueSeq().filter(function (g) {
                return g.isDead();
            });

            // detect suicide
            var newGroup = getGroup(newBoard, this.rowSize, this.colSize, coords);
            ...
            return createBoard(this.rowSize, this.colSize, newBoard);
        }
    }, {
        key: "areaScore",
        value: function areaScore() {
            ...
            var positions = allPositions(this.rowSize, this.colSize);
            ...
            positions.forEach(function (coords) {
                ...
                var group = getGroup(_this3.stones, _this3.rowSize, _this3.colSize, coords);
...
var createBoard = function createBoard(rowSize, colSize, stones) {
    return new Board(rowSize, colSize, stones);
};
exports.createBoard = createBoard;
},{"./constants":4,"./util":6,"immutable":7}],4:[function(require,module,exports){
/*
...
var Game = (function () {
    function Game(rowSize, colSize, values) {
        ...
        if (typeof values !== "undefined") {
            ...
            this.board = (0, _board.createBoard)(rowSize, colSize);
    ...
    _createClass(Game, [{
        ...
        value: function play(player, coords) {
            ...
            return createGame(this.rowSize, this.colSize, {
...
var createGame = function createGame(rowSize, colSize, values) {
    return new Game(rowSize, colSize, values);
};
exports.createGame = createGame;
},{"./board":3,"./constants":4,"./util":6,"immutable":7}],6:[function(require,module,exports){
"use strict";
